...
namespace MetaPersonaApi.Migrations
{
    ...
    [Migration("20240124080446_change_user_role_to_spawner")]
    partial class change_user_role_to_spawner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MetaPersonaApi.Identity.MetaPersonaIdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "02265ea8-5c04-47e1-9893-bf0564411aec",
                            Email = "omni001@proton.me",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "OMNI001@PROTON.ME",
                            NormalizedUserName = "OMNI001@PROTON.ME",
                            PasswordHash = "AQAAAAIAAYagAAAAEMy4iunFY1P6FOoKfykrG+dZIKPpOwq0aQ4xiaHWG6kPEhkqZWuM8+k/+N6t1n/ooA==",
